...
insert into restaurantes (slug, nome, categoria, cozinha, bairro, endereco, whatsapp, site_pedido, instagram, emoji, taxa_entrega, taxa_entrega_valor, pedido_minimo, pedido_minimo_valor, pagamentos, horarios, pausado, pausa_motivo, destaque, publicado, cardapio_atualizado_em, observacoes, posicao) values (
  'buteco-de-minas', 'Buteco de Minas', 'Hambúrguer', array['lanche','hambúrguer','porções','buteco','suco']::text[], 'Centro', '', '5535997666991', null, '', '🍔', '', null, null, null, array['Pix','Dinheiro','Cartão']::text[], '{"seg":null,"ter":["18:00","23:59"],"qua":["18:00","23:59"],"qui":["18:00","23:59"],"sex":["18:00","23:59"],"sab":["18:00","23:59"],"dom":["18:00","23:00"]}'::jsonb, false, null, false, false, '2026-09-08', 'Hambúrguer é carne tradicional. Nos lanches com hambúrguer (X-Burguer, X-Salada, X-Bacon, X-Salada Bacon, X-Egg, X-Tudo, Buteco Duplo Cheddar e Buteco Especial) dá pra trocar por costela, fraldinha ou picanha, nas seções de cada carne. Porções: meia porção com acréscimo de 30%.', 100
);
...
-- RED Lanches
insert into restaurantes (slug, nome, categoria, cozinha, bairro, endereco, whatsapp, site_pedido, instagram, emoji, taxa_entrega, taxa_entrega_valor, pedido_minimo, pedido_minimo_valor, pagamentos, horarios, pausado, pausa_motivo, destaque, publicado, cardapio_atualizado_em, observacoes, posicao) values (
  'red-lanches', 'RED Lanches', 'Hambúrguer', array['lanche','hambúrguer','hot dog','porções','prato executivo','cerveja']::text[], 'Centro', '', '5535984281806', null, '@red_lanchess', '🍔', 'Disk entrega até 23h, taxa R$ 5', 5, null, null, array['Pix','Dinheiro','Cartão']::text[], '{"seg":["12:00","22:00"],"ter":["12:00","22:00"],"qua":["12:00","22:00"],"qui":["12:00","22:00"],"sex":["12:00","22:00"],"sab":["12:00","22:00"],"dom":null}'::jsonb, false, null, false, true, '2026-09-08', 'Meia porção: acréscimo de 30%. Bebidas marcadas "consumo no local" não saem para entrega. Disk entrega até 23h, taxa R$ 5.', 100
);
